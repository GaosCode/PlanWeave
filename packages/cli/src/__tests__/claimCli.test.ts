...
import { runCli, expectCompletedExampleStatus, expectNoOrphanValidation, repoRoot, cliWorkflowTimeoutMs, type ExampleStatus, type ValidationReport } from "./support/cliTestHarness.js";
