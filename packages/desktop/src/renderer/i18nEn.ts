...
export const enCatalog = {
  ...
  workspaceCanvasSummaryLocal: "Needs attention",
  workspaceCanvasSummaryPrivate: "Only you",
  workspaceCanvasSummaryShared: "Shared",
  workspaceCanvasProjectCount: "{count} canvases",
