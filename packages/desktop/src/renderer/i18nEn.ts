...
export const enCatalog = {
  ...
  contentAuthorityForbidden:
    "This device cannot sync the selected canvas. Add it under Shared canvases, or sync a shared canvas listed below. [forbidden]",
  contentAuthorityCanvasNotHosted:
    "The selected canvas is not available to this Workspace. Sync a shared canvas below, or add the current canvas under Shared canvases.",
  ...
  localServerTitle: "Shared canvases",
  ...
  localServerScopeReadonlyHint:
    "The Server on this computer is stopped. Start it in Settings → Connections & Devices → Server before changing the shared scope.",
