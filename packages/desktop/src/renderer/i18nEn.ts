...
export const enCatalog = {
  ...
  workspaceCanvasSharingTitle: "Upload to Workspace",
  workspaceCanvasSharingDescription:
    "Upload local canvases from the connected project to create their Server-authoritative versions. Configure access below after upload.",
  workspaceCanvasSharingLoading: "Checking local canvases against Server authority…",
  workspaceCanvasSharingEmpty: "The connected project has no local canvases available to upload.",
  ...
  workspaceCanvasSharingVisibilityHint:
    "Uploading creates Server authority only; it does not grant member access. Use Canvas access below to configure private, shared, and member permissions.",
