...
export const enCatalog = {
  ...
  workspaceCanvasSharingDescription:
    "Register a local canvas in this Workspace and upload its first authoritative version. Uploading does not automatically share it with members.",
  workspaceCanvasSharingLoading: "Checking local canvases against Server authority…",
  workspaceCanvasSharingEmpty: "No local canvases belong to this Workspace.",
  workspaceCanvasStateLocalOnly: "Local only",
  workspaceCanvasStateUnpublished: "Registered, upload pending",
  workspaceCanvasStatePrivate: "Uploaded (private)",
  ...
  workspaceCanvasSharingVisibilityHint:
    "Only Shared means Workspace members can access it. Change visibility explicitly in Canvas access below.",
  ...
  contentAuthorityCanvasNotHosted:
    "The selected canvas is not registered on this Workspace Server. A Workspace owner must register and publish it before it can be synced.",
