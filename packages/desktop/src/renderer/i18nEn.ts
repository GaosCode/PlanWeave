...
export const enCatalog = {
  ...
  agentEndpointUnavailableLocalNotDetected: "Local Agent not detected",
  agentEndpointUnavailableLocalPreflightFailed: "Local Agent check failed",
  ...
  settingsConnectionsServerStopped: "Not connected",
  ...
  settingsServerExistingHint: "Enter the Server address to connect.",
  settingsServerAdmissionRequired:
    "Couldn’t connect with this address. Paste the complete connection details.",
  settingsServerHandoffFallback: "Paste connection details",
  settingsServerDeployTools: "Deploy tools",
  settingsServerDeployToolsHint: "Export a deploy package, or review the endpoint setup.",
  settingsServerCheckConnectivity: "Check connectivity",
  settingsServerCurrentConnection: "Current connection",
  ...
  hostAdminServerBinding: "Remote agents register with the currently connected Server.",
  ...
  deploymentDescription:
    "Host the collaboration Server on this computer, or connect to one already deployed.",
  deploymentKind: "Location",
  deploymentThisComputer: "This computer",
  deploymentExistingServer: "Existing Server",
  ...
  settingsServerDataImportHint:
    "Stop the Server on this computer first. If this computer already has Server data, import asks whether to replace all of it.",
  ...
  deploymentPrivateHttpsNote: "Tailscale provides private HTTPS.",
  ...
  deploymentTopologySource:
    "Validate the endpoint, then paste the setup handoff on this page to connect this device.",
  deploymentReview: "View deploy steps",
  ...
  deploymentExportNeedsProject: "The Server bundle could not be exported.",
  deploymentExportInvalidProject: "The Server bundle could not be created.",
  ...
  peopleYou: "you",
  peopleProfile: "Your profile",
  peopleProfileHint: "This is how other devices in this Workspace identify you.",
  peopleThisDevice: "This device",
  ...
  peopleWorkspaceDefaultName: "Current Workspace",
  peopleClose: "Close",
  ...
  peopleSetupDetailsHint: "Paste the complete connection details.",
  ...
  peopleWorkspaceIdentityVerifying: "Checking connection…",
  peopleWorkspaceIdentityVerified: "Connected",
  ...
  peopleIdentityRepairHint:
    "This Server has more than one historical Human identity. Recover identity credentials, then merge them with an explicit confirmation.",
  peopleIdentityRepairUnknownPrincipal: "Unknown identity",
  peopleIdentityRepairRecover: "Recover identity credentials",
  peopleIdentityRepairCanonical: "Keep this identity",
  peopleIdentityRepairSource: "Merge this identity into it",
  peopleIdentityRepairConfirm: "I confirm these identities belong to the same person",
  peopleIdentityRepairMerge: "Merge identities",
  ...
  workspaceCanvasSharingTitle: "Shared canvases",
  workspaceCanvasSharingDescription:
    "Choose a local project to see its shared canvases or add another canvas to this Workspace.",
  workspaceCanvasSharingExpand: "Manage shared canvases",
  workspaceCanvasSharingCollapse: "Collapse shared canvases",
  workspaceCanvasProjectLabel: "Project",
  workspaceCanvasProjectPlaceholder: "Choose a project",
  workspaceCanvasSharedListTitle: "Shared in this Workspace",
  workspaceCanvasSharedListDescription:
    "Canvases from {project} that Workspace members can access.",
  workspaceCanvasSharedCount: "{count} shared",
  workspaceCanvasSharedEmptyTitle: "No shared canvases yet",
  workspaceCanvasSharedEmptyDescription: "Choose a canvas below to share it with the Workspace.",
  workspaceCanvasAddTitle: "Add a shared canvas",
  workspaceCanvasAddDescription:
    "Choose an unshared canvas from this project. Its local files will remain on this computer.",
  workspaceCanvasAddLabel: "Canvas",
  workspaceCanvasAddPlaceholder: "Choose an unshared canvas",
  workspaceCanvasAddAction: "Add to shared canvases",
  workspaceCanvasAddEmpty: "Every canvas in this project is already shared.",
  ...
  workspaceCanvasStateOutdated: "Content differs",
  workspaceCanvasStatePrivate: "Only you",
  workspaceCanvasStateShared: "Shared",
  workspaceCanvasLocalDescription: "Currently stored on this computer only",
  workspaceCanvasIncompleteDescription: "The previous attempt did not finish; you can retry",
  workspaceCanvasOutdatedDescription: "Local content differs from the Workspace version",
  workspaceCanvasPrivateDescription: "Saved to the Workspace and hidden from other members",
  workspaceCanvasSharedDescription: "Confirmed available to Workspace members",
  workspaceCanvasPublish: "Upload to Workspace",
  workspaceCanvasRetryPublish: "Retry upload",
  workspaceCanvasPublishing: "Uploading…",
  workspaceCanvasShare: "Share canvas",
  workspaceCanvasMakeShared: "Make shared",
  workspaceCanvasSharing: "Sharing…",
  workspaceCanvasVerified: "Sharing complete",
  workspaceCanvasNeedsAttention: "Needs attention",
  workspaceCanvasShareFailedTitle: 'Could not share "{canvas}"',
  workspaceCanvasShareFailedPublish:
    "The canvas could not be saved to the Workspace. Check the connection and try again.",
  workspaceCanvasShareFailedVisibility:
    "The canvas was saved, but member access could not be enabled. Check your permissions and try again.",
  workspaceCanvasShareFailedVerify:
    "The request finished, but member access could not be confirmed. Refresh and try again.",
  workspaceCanvasShareDiagnostics: "View diagnostic details",
  workspaceCanvasShareDiagnosticStep: "Failed step",
  workspaceCanvasShareDiagnosticCode: "Error code",
  workspaceCanvasShareDiagnosticCanvas: "Canvas ID",
  workspaceCanvasShareDiagnosticUnavailable: "Unavailable",
  ...
  workspaceCanvasRetryShare: "Continue sharing",
  ...
  remoteRunPreparingEnvironment: "Preparing the execution environment",
  remoteRunPhasePreparing: "Preparing the execution environment",
  ...
  localServerProvidedByLocal: "These canvases are provided by the Server on this computer",
  localServerProvidedByOrigin: "These canvases are provided by {origin}",
  localServerManage: "Manage Server",
  localServerScopeReadonlyHint:
    "The Server on this computer is stopped. Start it in Settings → Connections & Devices → Server before changing the local hosting scope.",
  localServerRunning: "Running on this device",
  localServerStopped: "Stopped",
  localServerProcess: "Server status",
  localServerStart: "Start",
  localServerStop: "Stop",
  localServerScopeTitle: "Local hosting scope",
  localServerScopeHint:
    "Only applied selections are hosted here. Remote Workspace sharing is managed by that Server's canvas access settings.",
  localServerSelectedCount: "{count} hosted",
  localServerScopeExpand: "Show local hosting selection",
  localServerScopeCollapse: "Hide local hosting selection",
  ...
  localServerHosted: "Hosted here",
  localServerPrivate: "Not hosted here",
  localServerPendingAdd: "Pending apply",
  localServerPendingRemove: "Pending removal",
  localServerNoProjects: "Add a project with a task canvas before starting the service.",
  localServerScopeChanged:
    "Local hosting changes are pending. Applying will briefly refresh the local connection.",
