...
export const remoteAgentManagementZhCnCatalog = {
  ...
  remoteAgentManagementLocalCanvas: "本地画布",
  remoteAgentManagementLocalCanvasAllow: "允许",
  remoteAgentManagementLocalCanvasDeny: "不允许",
  remoteAgentManagementGrants: "已授权画布",
  remoteAgentManagementNoGrants: "暂无有效授权",
  remoteAgentManagementAddGrant: "添加授权",
  remoteAgentManagementWorkspaceId: "选择画布",
  remoteAgentManagementNoCanvases: "没有可授权的画布。",
