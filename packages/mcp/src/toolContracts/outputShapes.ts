...
export const taskCanvasSummarySchema = z
  .object({
    canvasId: z.string(),
    name: z.string(),
    taskCount: z.number(),
...
export const sanitizedProjectSchema = z
  .object({
    projectId: z.string(),
    name: z.string(),
    ...
    tasks: z.array(
      z
        .object({
          ...
          // Bounded graph responses omit promptMarkdown; full/debug variants may include it.
          promptMarkdown: z.string().optional(),
          promptMarkdownAvailable: z.boolean().optional(),
          promptMarkdownBytes: z.number().optional(),
          promptMissing: z.boolean(),
...
export const graphContextSummarySchema = z
  .object({
    canvasId: z.string(),
    name: z.string(),
    taskCount: z.number(),
...
export const blockDetailSchema = z
  .object({
    ref: z.string(),
    taskId: z.string(),
    blockId: z.string(),
...
export const reviewPipelineSchema = z
  .object({
    taskId: z.string(),
    taskTitle: z.string(),
    packageDefaults: z
...
export const schemaDocumentSchema = z
  .object({
    name: z.string(),
    summary: z.string(),
    path: z.string(),
...
export const schemaTopicSummarySchema = z
  .object({
...
export const planweaveGuideSchema = z
  .object({
    summary: z.string(),
    concepts: z.array(
      z
...
export const packageExampleSummarySchema = z
  .object({
    template: z.string(),
    title: z.string(),
    description: z.string(),
...
export const planPackageExportSchema = z
  .object({
...
const packageFileSummarySchema = z
  .object({
    path: z.string(),
    encoding: z.literal("utf8"),
...
export const planPackageExportSummarySchema = z
  .object({
    canvasId: z.string().nullable(),
    fileCount: z.number(),
...
export const projectExportSummarySchema = z
  .object({
...
export const projectExportFilesSchema = z
  .object({
    project: sanitizedProjectSchema,
...
const graphQualitySummarySchema = z
  .object({
    taskCount: z.number(),
    blockCount: z.number(),
...
const graphQualityDiagnosticSchema = z
  .object({
    code: z.string(),
...
export const graphQualityReportSchema = z
  .object({
    ok: z.boolean(),
...
const packageDraftCanvasReportSchema = z
  .object({
    canvasId: z.string().nullable(),
    packageDir: z.string(),
...
export const packageDraftValidationSchema = z
  .object({
    ok: z.boolean(),
    draftRoot: z.string(),
...
const packageDraftFileDiffSchema = z
  .object({
    path: z.string(),
...
const packageDraftImportEffectSchema = z
  .object({
    type: z.enum([
      "replace_package",
      "reset_state",
...
export const packageDraftImportPreviewSchema = packageDraftValidationSchema
  .extend({
    target: z
      .object({
...
export const packageDraftImportApplySchema = packageDraftImportPreviewSchema
  .extend({
    applied: z.boolean()
  })
  .passthrough();

const graphInspectionPageSchema = z
  .object({
    limit: z.number(),
...
const graphInspectionTaskSchema = z
  .object({
    taskId: z.string(),
    title: z.string(),
    status: z.enum(taskStatuses),
...
const graphInspectionBlockSchema = z
  .object({
    ref: z.string(),
    blockId: z.string(),
    type: z.enum(blockTypes),
...
const graphInspectionEdgeSchema = z
  .object({
    from: z.string(),
    to: z.string(),
...
export const graphInspectionSchema = z.discriminatedUnion("view", [
  z
    .object({
...
export const executionReadinessReportSchema = z
  .object({
    ok: z.boolean(),
    summary: z
      .object({
...
export const toolGroupsSchema = z
  .object({
    name: z.string(),
    purpose: z.string(),
...
export const packageContentRefSchema = z
  .object({
...
export const packageFileListSchema = {
  files: z.array(
    z
      .object({
        path: z.string(),
...
export const packageContentReadSchema = z
  .object({
    contentRef: packageContentRefSchema,
    content: z.string(),
    truncated: z.boolean()
...
export const graphEditOutputSchema = {
...
export const bulkEditOutputSchema = {
...
export const readyBlockSchema = z
  .object({
    canvasId: z.string().nullable(),
...
export const planweaveContextProjectSchema = z
  .object({
    project: sanitizedProjectSchema,
...
export const projectGraphEditOutputSchema = {
  projectGraphEdit: z
    .object({
      ok: z.boolean(),
      diagnostics: z.array(validationIssueSchema),
